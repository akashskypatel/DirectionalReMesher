...
if(GMP_INCLUDE_DIRS)
  message(STATUS "GMP Include found: ${GMP_INCLUDE_DIRS}")
else()
  message(STATUS "GMP Include directory not found")
endif()

if(GMP_LIBRARIES)
  message(STATUS "GMP Libraries found: ${GMP_LIBRARIES}")
else()
  message(STATUS "GMP Libraries not found")
endif()

if(GMP_LIBRARY_DIRS)
  message(STATUS "GMP Library directories found: ${GMP_LIBRARY_DIRS}")
else()
  message(STATUS "GMP Library directories not found")
endif()

if(GMPXX_LIBRARIES)
  message(STATUS "GMPXX Library found: ${GMPXX_LIBRARIES}")
else()
  message(STATUS "GMPXX Library not found")
endif()

if (GMP_INCLUDE_DIRS AND GMP_LIBRARIES)
  list(APPEND SUITESPARSE_TARGETS GMP::GMP)
...
if (GMP_INCLUDE_DIRS AND GMPXX_LIBRARIES)
  list(APPEND SUITESPARSE_TARGETS GMP::GMPXX)
  if (NOT TARGET GMP::GMPXX)
    add_library(GMP::GMPXX IMPORTED UNKNOWN)
  endif (NOT TARGET GMP::GMPXX)

  set_property(TARGET GMP::GMPXX PROPERTY
    INTERFACE_INCLUDE_DIRECTORIES ${GMP_INCLUDE_DIRS})
  set_property(TARGET GMP::GMPXX PROPERTY
    IMPORTED_LOCATION ${GMPXX_LIBRARIES})
  # Explicitly link the regular C gmp dependency into the C++ target interface
  set_property(TARGET GMP::GMPXX PROPERTY
    INTERFACE_LINK_LIBRARIES GMP::GMP)
endif (GMP_INCLUDE_DIRS AND GMPXX_LIBRARIES)